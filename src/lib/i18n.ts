export const zh = {
  ...
  permInvited: '💌 仅受邀用户', permFriendsOnly: '👥 仅好友', permInvitedFriends: '💌👥 仅受邀好友', permPrivate: '🔒 仅自己',
  shareClose: '关闭', viewOnly: '只读',
  invitedLists: '受邀的清单', invitedListsEmpty: '暂无受邀清单', shareListToFriend: '分享清单', shareListSent: '已发送', inviteSection: '受邀用户', inviteFriendsSection: '好友邀请',
  // Admin
...
export const en: Record<I18nKey, string> = {
  ...
  permInvited: '💌 Invited only', permFriendsOnly: '👥 Friends only', permInvitedFriends: '💌👥 Invited friends only', permPrivate: '🔒 Only me',
  shareClose: 'Close', viewOnly: 'View only',
  invitedLists: 'Invited Lists', invitedListsEmpty: 'No invited lists', shareListToFriend: 'Share list', shareListSent: 'Sent', inviteSection: 'Invited users', inviteFriendsSection: 'Invite friends',
